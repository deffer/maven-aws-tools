...
|no +
_(default file)_
|`env \| java \| file \| instance \| provided`. See below for description.
...
The `credentialProvider` configuration has next options (which corresponds to those described http://docs.aws.amazon.com/AWSSdkDocsJava/latest//DeveloperGuide/credentials.html[here])
